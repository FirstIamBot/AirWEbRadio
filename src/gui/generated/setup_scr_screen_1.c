...
void setup_scr_screen_1(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->screen_1_cont_1, 6, 7);
	lv_obj_set_size(ui->screen_1_cont_1, 309, 450);
	...
	//Write codes screen_1_slider_vol
	ui->screen_1_slider_vol = lv_slider_create(ui->screen_1_cont_1);
	lv_slider_set_range(ui->screen_1_slider_vol, 0, 100);
	lv_slider_set_mode(ui->screen_1_slider_vol, LV_SLIDER_MODE_SYMMETRICAL);
	lv_slider_set_value(ui->screen_1_slider_vol, 50, LV_ANIM_OFF);
	lv_obj_set_pos(ui->screen_1_slider_vol, 18, 276);
	lv_obj_set_size(ui->screen_1_slider_vol, 272, 8);

	//Write style for screen_1_slider_vol, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_1_slider_vol, 60, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_1_slider_vol, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_1_slider_vol, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_1_slider_vol, 50, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_outline_width(ui->screen_1_slider_vol, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_1_slider_vol, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write style for screen_1_slider_vol, Part: LV_PART_INDICATOR, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_1_slider_vol, 255, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_1_slider_vol, lv_color_hex(0x2195f6), LV_PART_INDICATOR|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_1_slider_vol, LV_GRAD_DIR_NONE, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_1_slider_vol, 50, LV_PART_INDICATOR|LV_STATE_DEFAULT);

	//Write style for screen_1_slider_vol, Part: LV_PART_KNOB, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_1_slider_vol, 255, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_1_slider_vol, lv_color_hex(0x2195f6), LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_1_slider_vol, LV_GRAD_DIR_NONE, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_1_slider_vol, 50, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_1_btn_1, 16, 15);
	lv_obj_set_size(ui->screen_1_btn_1, 37, 27);
	...
	lv_obj_add_flag(ui->screen_1_btn_2, LV_OBJ_FLAG_CHECKABLE);
	...
	lv_obj_set_pos(ui->screen_1_btn_2, 20, 117);
